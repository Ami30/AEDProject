 ...
 * @author amishagupta
 */
public class ManageSanitizationEntEmpJPanel extends javax.swing.JPanel {
    ...
    public ManageSanitizationEntEmpJPanel(JPanel userProcessContainer,OrganizationDirectory organizationDir,Enterprise ent) {
        ...
        organizationSanitizationJTable.setRowHeight(25);
        organizationSanitizationJTable.getTableHeader().setDefaultRenderer(new HeaderColor());
    ...
    private void populateSanitizationPersonTable(){
        DefaultTableModel model = (DefaultTableModel) organizationSanitizationJTable.getModel();
    ...
    private void initComponents() {
        ...
        organizationSanitizationJTable = new javax.swing.JTable();
        lblDoctorslist1 = new javax.swing.JLabel();
        btnRemoveSanitizationProvider = new javax.swing.JButton();
        ...
        organizationSanitizationJTable.setRequestFocusEnabled(false);
        organizationSanitizationJTable.setSelectionBackground(new java.awt.Color(235, 227, 126));
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(btnRemoveSanitizationProvider, javax.swing.GroupLayout.Alignment.TRAILING))
                        .addContainerGap())
    ...
    private void btnRemoveSanitizationProviderActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRemoveSanitizationProviderActionPerformed
        // TODO add your handling code here:
        int row = organizationSanitizationJTable.getSelectedRow();
        if(row<0) {
            JOptionPane.showMessageDialog(null, "Please select a row from the table first", "Warning", JOptionPane.WARNING_MESSAGE);
            return;
        }
        SanitizationPerson saniPerson=(SanitizationPerson)organizationSanitizationJTable.getValueAt(row, 0);
        
       for(int i=0;i<organizationDir.getOrgList().size();i++){
           Organization o= organizationDir.getOrgList().get(i);
           Boolean success=o.getSaniPersonDir().removesanitizationPerson(saniPerson);
           if(success){
               o.getEmpDir().removeEmpByName(saniPerson.getFullName());
               o.getUserAccountDir().removeUserAccountByUserName(saniPerson.getFullName());
           }
       }      
...
//        }
    ...
    private javax.swing.JButton btnRemoveSanitizationProvider;
    ...
    private javax.swing.JTable organizationSanitizationJTable;
