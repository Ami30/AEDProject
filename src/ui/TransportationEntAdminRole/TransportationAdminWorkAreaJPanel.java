...
public class TransportationAdminWorkAreaJPanel extends javax.swing.JPanel {
    ...
    private void btnManageUsersActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnManageUsersActionPerformed
        // TODO add your handling code here:
        ManageTransportEntUserJPanel manageUserJPanel=new ManageTransportEntUserJPanel(workAreaJPanel,enterprise);
        workAreaJPanel.add("ManageEnterpriseAdminJPanel", manageUserJPanel);
        CardLayout layout = (CardLayout) workAreaJPanel.getLayout();
        layout.next(workAreaJPanel);
