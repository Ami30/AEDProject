 ...
 * @author amishagupta
 */
public class RequestDetailsStorePersonReportJPanel extends javax.swing.JPanel {
    ...
    public RequestDetailsStorePersonReportJPanel(JPanel userProcessContainer,Enterprise enterprise, UserAccount account, EcoSystem system, HealthRequest request,GroceryStorePerson storePerson) {
        initComponents();
    ...
    private void initComponents() {
        ...
        itemsRequestedtable = new javax.swing.JTable();
        ...
        itemsRequestedtable.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {null, null, null, null},
                {null, null, null, null},
                {null, null, null, null},
            ...
            new String [] {
                "Item Name", "Item Quantity", "Delivery Man", "Order Status"
            }
        ) {
        ...
        jScrollPane2.setViewportView(itemsRequestedtable);
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        DeliveredItemsJPanel deliveredItems=new DeliveredItemsJPanel(userProcessContainer,enterprise,useraccount,system, request);
        userProcessContainer.add("userReport", deliveredItems);
    ...
    private void btnAssigndeliveryManActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAssigndeliveryManActionPerformed
        // TODO add your handling code here:
        int row = itemsRequestedtable.getSelectedRow();
        if(row<0) {
...
//            Tests test = (Tests)testAssignedTable.getValueAt(row, 0);
              Items item=(Items)itemsRequestedtable.getValueAt(row, 0);
              item.setOrderStatus("Delivery Man Assigned");
...
//            layout.next(userProcessContainer);
     ...
     private void populateComboBox(){
      ...
      private void populateTable(){
        DefaultTableModel model = (DefaultTableModel) itemsRequestedtable.getModel();
        model.setRowCount(0);
        for (Items item : storePerson.getItemsDirectory().getItemsList()){          
            Object[] row = new Object[4];
            row[0] = item;
            row[1] = item.getItemQuantity();
            row[2] = item.getDeliveryMan();
            row[3] = item.getOrderStatus();
            model.addRow(row);
        }
    ...
    private javax.swing.JTable itemsRequestedtable;
