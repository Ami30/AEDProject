 ...
 * @author amishagupta
 */
public class StorePersonAssignedRequestJPanel extends javax.swing.JPanel {
    ...
    public StorePersonAssignedRequestJPanel(JPanel userProcessContainer,Enterprise enterprise, UserAccount account, EcoSystem system, Organization organization) {
        initComponents();
     ...
     public void populateRequestTable() {
        ...
        model.setRowCount(0);
        GroceryStorePerson storePerson = null;
       for(Organization org : enterprise.getOrganizationDirectory().getOrgList()){
           if(org.getGrocPerDir().findStorePerson(useraccount.getUsername())!= null){
              storePerson = org.getGrocPerDir().findStorePerson(useraccount.getUsername());
              for(HealthRequest req : storePerson.getRequestDirectory().getRequestList()){
        ...
        if (selectedRow < 0){
            ...
            for(Organization org : enterprise.getOrganizationDirectory().getOrgList()){
                if(org.getGrocPerDir().findStorePerson(useraccount.getUsername())!= null){
                    ...
                    RequestDetailsStorePersonReportJPanel requestDetails=new RequestDetailsStorePersonReportJPanel(userProcessContainer,enterprise,useraccount,system, req,storePerson);
    ...
    private void btnCompletedOrderActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCompletedOrderActionPerformed
        ...
        if (selectedRow < 0){
            ...
            req = (HealthRequest)SubmittedrequestsJTable.getValueAt(selectedRow, 0);
            DeliveredItemsJPanel deliveredItems=new DeliveredItemsJPanel(userProcessContainer,enterprise,useraccount,system, req);
