 ...
 * @author amishagupta
 */
public class OrderDetailsDelmanJPanel extends javax.swing.JPanel {
    ...
    public OrderDetailsDelmanJPanel(JPanel userProcessContainer,Enterprise ent, UserAccount userAccount, EcoSystem system, Organization org, OrderMedicine ordMed) {
        initComponents();
    ...
    private void btnSubmitActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSubmitActionPerformed
       ...
       medicineList.clear();
       DeliveryManAssignedRequestJPanel orderMedicine=new DeliveryManAssignedRequestJPanel(userProcessContainer,ent,userAccount,system, org);
    ...
    private void populateDetails(){
        lblPatientName.setText(ordMed.getUser().getName());
