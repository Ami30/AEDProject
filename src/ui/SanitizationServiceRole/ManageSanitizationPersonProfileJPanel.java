 ...
 * @author amishagupta
 */
public class ManageSanitizationPersonProfileJPanel extends javax.swing.JPanel {
    ...
    public ManageSanitizationPersonProfileJPanel(JPanel userProcessContainer,Enterprise enterprise, UserAccount account, EcoSystem system) throws ParseException {
        initComponents();
    ...
    private void initComponents() {
        ...
        jPanel3Layout.setVerticalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(txtZipCode, javax.swing.GroupLayout.PREFERRED_SIZE, 42, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(lblZipCode))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
    ...
    private void addJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addJButtonActionPerformed
       ...
       for(Organization org : enterprise.getOrganizationDirectory().getOrgList()){
           if(org.getSaniPersonDir().findSaniPerson(username)!= null){
               saniPerson = org.getSaniPersonDir().findSaniPerson(username);
        saniPerson.setFullName(name);
        saniPerson.setAddress(address);
        saniPerson.setEmail(email);
        saniPerson.setZipcode(zipcode);
        saniPerson.setContactNumber(contactNumber);
    ...
    private void populateprofile() throws ParseException {
       ...
       for(Organization org : enterprise.getOrganizationDirectory().getOrgList()){
           if(org.getSaniPersonDir().findSaniPerson(username)!= null){
               saniPerson = org.getSaniPersonDir().findSaniPerson(username);
               nameJTextField.setText(saniPerson.getFullName());
            txtAddress.setText(saniPerson.getAddress());
            txtZipCode.setText(saniPerson.getZipcode());
            txtContactNo.setText(saniPerson.getContactNumber());
            GenderCombobox.setSelectedItem(saniPerson.getGender());  
            txtEmail.setText(saniPerson.getEmail());       
            String birthDate = saniPerson.getDob();   
           }
       }
    }
}
