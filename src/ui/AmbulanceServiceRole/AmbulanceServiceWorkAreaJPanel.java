...
import ui.CabServiceRole.CabServiceAssignedRequestJPanel;
...
public class AmbulanceServiceWorkAreaJPanel extends javax.swing.JPanel {
    ...
    private void btnManageProfileTesterActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnManageProfileTesterActionPerformed
        try {
            ...
            ManageCabServiceProfileJPanel manageCabProfile=new ManageCabServiceProfileJPanel(workAreaJPanel,enterprise,useraccount,system);
            workAreaJPanel.add("manageCabProfile", manageCabProfile);
    ...
    private void btnManageProfile1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnManageProfile1ActionPerformed
        // TODO add your handling code here:
        CabServiceAssignedRequestJPanel cabRequestAssigned=new CabServiceAssignedRequestJPanel(workAreaJPanel,enterprise,useraccount,system, org);
        workAreaJPanel.add("cabRequestAssigned", cabRequestAssigned);
        CardLayout layout = (CardLayout) workAreaJPanel.getLayout();
        layout.next(workAreaJPanel);
    ...
    private void btnManageProfile2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnManageProfile2ActionPerformed
        // TODO add your handling code here:
        AddServicesJAreaPanel cabServiceRequest=new AddServicesJAreaPanel(workAreaJPanel,enterprise,useraccount,system,org);
        workAreaJPanel.add("cabServiceRequest", cabServiceRequest);
        CardLayout layout = (CardLayout) workAreaJPanel.getLayout();
        layout.next(workAreaJPanel);
