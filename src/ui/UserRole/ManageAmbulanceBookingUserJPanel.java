 ...
 * @author amishagupta
 */
public class ManageAmbulanceBookingUserJPanel extends javax.swing.JPanel {
    ...
    public ManageAmbulanceBookingUserJPanel(JPanel userProcessContainer,Enterprise enterprise, UserAccount account, EcoSystem system, Organization organization) {
        initComponents();
  ...
  public void populateRequestTable() {
        ...
        model.setRowCount(0);
            RegisteredUser user = system.getRegisteredUserDirectory().findRegisteredUser(useraccount.getUsername());
           for(ServiceRequest serReq : user.getServiceRequestDirectoryAmb().getServiceRequestList()){
    ...
    private void ApprovedActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ApprovedActionPerformed
        ...
        BookAmbulanceUserJPanel bookAmbulanceJPanel=new BookAmbulanceUserJPanel(userProcessContainer,enterprise,useraccount,system,organization);
