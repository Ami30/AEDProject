...
public class AssignHospitalToRequest extends javax.swing.JPanel {
    ...
    public AssignHospitalToRequest(JPanel userProcessContainer,Enterprise enterprise, UserAccount account, EcoSystem system, HealthRequest request, Organization org) {
        ...
        this.comorbid=new ArrayList<>();
         HospitalJTable.setRowHeight(25);
        HospitalJTable.getTableHeader().setDefaultRenderer(new HeaderColor());
    ...
    private void initComponents() {
        ...
        HospitalJTable.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Hospital Name", "Available Beds", "Zipcode"
            }
        ));
        HospitalJTable.setSelectionBackground(new java.awt.Color(204, 204, 204));
         ...
         if (selectedRow < 0){
            ...
            return;
             ...
             if(request.getHospital()==null){
                 HospitalEnterprise hospEnt = (HospitalEnterprise)HospitalJTable.getValueAt(selectedRow, 0);
